...
class Svgfile
{
    public:
        ...
        void addEllipse(double x, double y, double rx, double ry,  std::string color, std::string stroke);

        void addRectangle(double x, double y, double w, double h, std::string color=defcol);
